...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.update_group'
        db.add_column(u'search_document', 'update_group',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document.update_group'
        db.delete_column(u'search_document', 'update_group')
    ...
    models = {
        u'search.document': {
            ...
            'update_group': ('django.db.models.fields.SmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
