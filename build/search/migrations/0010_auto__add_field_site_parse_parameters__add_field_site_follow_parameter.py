...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Site.parse_parameters'
        db.add_column(u'search_site', 'parse_parameters',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Site.follow_parameters'
        db.add_column(u'search_site', 'follow_parameters',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Site.deny_parameters'
        db.add_column(u'search_site', 'deny_parameters',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Site.parse_parameters'
        db.delete_column(u'search_site', 'parse_parameters')

        # Deleting field 'Site.follow_parameters'
        db.delete_column(u'search_site', 'follow_parameters')

        # Deleting field 'Site.deny_parameters'
        db.delete_column(u'search_site', 'deny_parameters')
