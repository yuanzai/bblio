...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Job.instance_ip'
        db.delete_column(u'search_job', 'instance_ip')

        # Adding field 'Job.instance'
        db.add_column(u'search_job', 'instance',
                      self.gf('django.db.models.fields.CharField')(default='migrate', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Job.instance_ip'
        db.add_column(u'search_job', 'instance_ip',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=30),
                      keep_default=False)

        # Deleting field 'Job.instance'
        db.delete_column(u'search_job', 'instance')
