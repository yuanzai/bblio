...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TextFilter'
        db.create_table(u'search_textfilter', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['search.Site'])),
            ('filter_type', self.gf('django.db.models.fields.CharField')(max_length=30, db_index=True)),
            ('filter_text', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'search', ['TextFilter'])


    def backwards(self, orm):
        # Deleting model 'TextFilter'
        db.delete_table(u'search_textfilter')
