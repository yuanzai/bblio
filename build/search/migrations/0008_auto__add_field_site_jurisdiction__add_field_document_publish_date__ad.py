...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Site.jurisdiction'
        db.add_column(u'search_site', 'jurisdiction',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Document.publish_date'
        db.add_column(u'search_document', 'publish_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding index on 'Document', fields ['update_group']
        db.create_index(u'search_document', ['update_group'])

        # Adding index on 'Document', fields ['isUsed']
        db.create_index(u'search_document', ['isUsed'])


    def backwards(self, orm):
        # Removing index on 'Document', fields ['isUsed']
        db.delete_index(u'search_document', ['isUsed'])

        # Removing index on 'Document', fields ['update_group']
        db.delete_index(u'search_document', ['update_group'])

        # Deleting field 'Site.jurisdiction'
        db.delete_column(u'search_site', 'jurisdiction')

        # Deleting field 'Document.publish_date'
        db.delete_column(u'search_document', 'publish_date')
