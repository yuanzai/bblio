...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'search_document', 'title', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Document.document_text'
        db.alter_column(u'search_document', 'document_text', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Document.title'
        db.alter_column(u'search_document', 'title', self.gf('django.db.models.fields.TextField')(default=None))

        # Changing field 'Document.document_text'
        db.alter_column(u'search_document', 'document_text', self.gf('django.db.models.fields.TextField')(default=None))
