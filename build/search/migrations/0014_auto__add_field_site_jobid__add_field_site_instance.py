...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Site.jobid'
        db.add_column(u'search_site', 'jobid',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Site.instance'
        db.add_column(u'search_site', 'instance',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Site.jobid'
        db.delete_column(u'search_site', 'jobid')

        # Deleting field 'Site.instance'
        db.delete_column(u'search_site', 'instance')
