...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document.index_batch'
        db.add_column(u'search_document', 'index_batch',
                      self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Document.head'
        db.add_column(u'search_document', 'head',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['search.TextFilter']),
                      keep_default=False)

        # Adding field 'Document.foot'
        db.add_column(u'search_document', 'foot',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['search.TextFilter']),
                      keep_default=False)

        # Adding field 'Document.isPDF'
        db.add_column(u'search_document', 'isPDF',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document.index_batch'
        db.delete_column(u'search_document', 'index_batch')

        # Deleting field 'Document.head'
        db.delete_column(u'search_document', 'head_id')

        # Deleting field 'Document.foot'
        db.delete_column(u'search_document', 'foot_id')

        # Deleting field 'Document.isPDF'
        db.delete_column(u'search_document', 'isPDF')
    ...
    models = {
        u'search.document': {
            ...
            'foot': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['search.TextFilter']"}),
            'head': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['search.TextFilter']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'index_batch': ('django.db.models.fields.IntegerField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
            'isPDF': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'isUsed': ('django.db.models.fields.SmallIntegerField', [], {'default': '0', 'db_index': 'True'}),
        ...
        u'search.textfilter': {
            'Meta': {'object_name': 'TextFilter'},
            'filter_id': ('django.db.models.fields.IntegerField', [], {'db_index': 'True', 'max_length': '8', 'null': 'True', 'blank': 'True'}),
            'filter_text': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'filter_type': ('django.db.models.fields.CharField', [], {'max_length': '30', 'db_index': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['search.Site']"})
        }
    }
