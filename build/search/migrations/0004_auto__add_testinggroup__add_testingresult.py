...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'search_testinggroup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'search', ['TestingGroup'])

        # Adding model 'TestingResult'
        db.create_table(u'search_testingresult', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('document', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['search.Document'])),
            ('score', self.gf('django.db.models.fields.IntegerField')()),
            ('testinggroup', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['search.TestingGroup'])),
            ('searchterm', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'search', ['TestingResult'])


    def backwards(self, orm):
        # Deleting model 'TestingGroup'
        db.delete_table(u'search_testinggroup')

        # Deleting model 'TestingResult'
        db.delete_table(u'search_testingresult')
