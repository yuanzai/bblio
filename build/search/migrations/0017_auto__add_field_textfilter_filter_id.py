...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TextFilter.filter_id'
        db.add_column(u'search_textfilter', 'filter_id',
                      self.gf('django.db.models.fields.IntegerField')(db_index=True, max_length=8, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TextFilter.filter_id'
        db.delete_column(u'search_textfilter', 'filter_id')
