...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'search_job', (
            ...
            ('scrapyd_job_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['search.Site'])),
            ('instance_ip', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
    ...
    models = {
        ...
        u'search.job': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instance_ip': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
